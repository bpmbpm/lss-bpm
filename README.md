...
Проверяем наличие папок pages, logseq, .git   

Запускаем logseq, Меню: "Добавить новый граф".   
Выбираем папку (например, C:/Temp/logseq2).   
Варианты синхронизации:
а) штатная функция Logseq, см. Настройка "Управление вериями";   
б) ручное обновление через расширение Git (A git plugin for logseq), "Commit & Push" (обновляет все файлы папки ,включая README.md)    
